...
#Properties: {
	...
	StartoverWindowSeconds?: int & >=0 & <=1209600
	Tags?: [...#Tag]
...
#DashBaseUrl: {
	...
	DvbWeight?: int & >=1 & <=15000
	// <p>The name of the source location.</p>
	ServiceLocation?: string & strings.MinRunes(1) & strings.MaxRunes(2048)
...
#DashDvbFontDownload: {
	...
	FontFamily?: string & strings.MinRunes(1) & strings.MaxRunes(256)
	...
	MimeType?: string & =~"^[a-zA-Z0-9][a-zA-Z0-9_/-]*[a-zA-Z0-9]$" & strings.MinRunes(1) & strings.MaxRunes(256)
...
#DashDvbMetricsReporting: {
	...
	Probability?: int & >=1 & <=1000
	// <p>The URL where playback devices send error reports.</p>
	ReportingUrl: string & strings.MinRunes(1) & strings.MaxRunes(2048)
}
...
#DashManifestConfiguration: {
	...
	ManifestName: string & =~"^[a-zA-Z0-9_-]+$" & strings.MinRunes(1) & strings.MaxRunes(256)
...
#DashProgramInformation: {
	...
	LanguageCode?: string & =~"^[a-zA-Z0-9][a-zA-Z0-9_-]*[a-zA-Z0-9]$" & strings.MinRunes(2) & strings.MaxRunes(5)
	// <p>An absolute URL that contains more information about this content.</p>
	MoreInformationUrl?: string & strings.MinRunes(1) & strings.MaxRunes(2048)
	// <p>Information about the content provider.</p>
	Source?: string & strings.MinRunes(1) & strings.MaxRunes(2048)
...
#Encryption: {
	...
	ConstantInitializationVector?: string & =~"^[0-9a-fA-F]+$" & strings.MinRunes(32) & strings.MaxRunes(32)
...
#FilterConfiguration: {
	...
	DrmSettings?: string & strings.MinRunes(1) & strings.MaxRunes(1024)
	...
	ManifestFilter?: string & strings.MinRunes(1) & strings.MaxRunes(1024)
...
#MssManifestConfiguration: {
	...
	ManifestName: string & =~"^[a-zA-Z0-9-]+$" & strings.MinRunes(1) & strings.MaxRunes(256)
...
#Segment: {
	...
	SegmentName?: string & =~"^[a-zA-Z0-9_-]+$" & strings.MinRunes(1) & strings.MaxRunes(256)
...
#SpekeKeyProvider: {
	...
	CertificateArn?: string & =~"^arn:([^:\\n]+):acm:([^:\\n]+):([0-9]+):certificate/[a-zA-Z0-9-_]+$" & strings.MinRunes(20) & strings.MaxRunes(2048)
	...
	ResourceId: string & =~"^[0-9a-zA-Z_-]+$" & strings.MinRunes(1) & strings.MaxRunes(256)
	...
	Url: string & strings.MinRunes(1) & strings.MaxRunes(1024)
}
