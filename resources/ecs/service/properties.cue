...
#CanaryConfiguration: {
	...
	CanaryBakeTimeInMinutes?: int & >=0 & <=1440
...
#DeploymentLifecycleHook: {
 ...
 You can use a lifecycle hook for this stage.
  ...
  You must provide this parameter when configuring a deployment lifecycle hook.
	LifecycleStages: [..."RECONCILE_SERVICE" | "PRE_SCALE_UP" | "POST_SCALE_UP" | "TEST_TRAFFIC_SHIFT" | "POST_TEST_TRAFFIC_SHIFT" | "PRE_PRODUCTION_TRAFFIC_SHIFT" | "PRODUCTION_TRAFFIC_SHIFT" | "POST_PRODUCTION_TRAFFIC_SHIFT"]
...
#ForceNewDeployment: {
	...
	ForceNewDeploymentNonce?: string & strings.MinRunes(1) & strings.MaxRunes(255)
}

#HookTimeoutConfig: {
	Action?: "ROLLBACK" | "CONTINUE"
	TimeoutInMinutes?: int & >=1 & <=20160
}
...
#LinearConfiguration: {
	...
	StepBakeTimeInMinutes?: int & >=0 & <=1440
