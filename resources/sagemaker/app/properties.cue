...
#Properties: {
	// The name of the app.
	AppName: string & =~"^[a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}" & strings.MinRunes(1) & strings.MaxRunes(63)
	// The type of app.
	...
	UserProfileName: string & =~"^[a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}" & strings.MinRunes(1) & strings.MaxRunes(63)
}
...
#ResourceSpec: {
	...
	SageMakerImageArn?: string & =~"^arn:aws(-[\\w]+)*:sagemaker:.+:[0-9]{12}:image/[a-z0-9]([-.]?[a-z0-9])*$" & strings.MinRunes(1) & strings.MaxRunes(256)
	// The ARN of the image version created on the instance.
	SageMakerImageVersionArn?: string & =~"^arn:aws(-[\\w]+)*:sagemaker:.+:[0-9]{12}:image-version/[a-z0-9]([-.]?[a-z0-9])*/[0-9]+$" & strings.MinRunes(1) & strings.MaxRunes(256)
}
