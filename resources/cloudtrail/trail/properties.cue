...
#Properties: {
	...
	S3KeyPrefix?: string & strings.MaxRunes(200)
	// Specifies the name of the Amazon SNS topic defined for notification of log file delivery. The maximum length is 256 characters.
	SnsTopicName?: string & strings.MaxRunes(256)
	Tags?: [...#Tag]
	TrailName?: string & =~"(^[a-zA-Z0-9]$)|(^[a-zA-Z0-9]([a-zA-Z0-9\\._-])*[a-zA-Z0-9]$)" & strings.MinRunes(3) & strings.MaxRunes(128)
}
...
#SourceEventCategory: "Management" | "Data"
...
#Template: "API_ACTIVITY" | "RESOURCE_ACCESS" | "USER_ACTIONS"
