...
#Properties: {
	...
	AllocatePrivateVirtualInterfaceRoleArn?: string & =~"^arn:aws[a-z-]*:iam::[0-9]{12}:role/.+$"
	...
	VirtualGatewayId?: string & =~"^(arn:aws[a-z-]*:ec2:[a-z0-9-]+:[0-9]{12}:vpn-gateway/)?vgw-[a-zA-Z0-9]{8,32}$"
