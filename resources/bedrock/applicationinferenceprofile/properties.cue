...
#InferenceProfileModelSource: {
	CopyFrom: string & =~"^arn:aws(|-us-gov|-cn|-iso|-iso-b):bedrock:(|[0-9a-z-]{0,20}):(|[0-9]{12}):(inference-profile|foundation-model)/[a-zA-Z0-9-:.]+$" & strings.MinRunes(1) & strings.MaxRunes(2048)
}

#InferenceProfileStatus: "ACTIVE"

#InferenceProfileType: "APPLICATION" | "SYSTEM_DEFINED"
