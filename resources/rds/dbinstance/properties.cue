...
#Properties: {
	...
	AutomaticBackupReplicationRetentionPeriod?: int & >=1
	...
	DBInstanceIdentifier?: string & =~"^$|^[a-zA-Z]{1}(?:-?[a-zA-Z0-9]){0,62}$" & strings.MinRunes(1) & strings.MaxRunes(63)
	...
	// +  First character must be a letter.
	// +  Can't be a reserved word for the chosen database engine.
	MasterUsername?: string & =~"^[a-zA-Z][a-zA-Z0-9_]{0,127}$" & strings.MinRunes(1) & strings.MaxRunes(128)
